...
$password = md5(mysql_real_escape_string($_POST['reg_password'])."@#$%^&*&$");
...
if($soa_email_check != true && $soa_username_check != true)
{
mysql_query("INSERT INTO soa_users (username,email,first_name,last_name,password,date_created) VALUES('$username','$email','$first_name','$last_name','$password','$date_created')");	
$success = true;
}
else
{
