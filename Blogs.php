            ...
            <div id="content-outer">
                <div class="double-col empty">
                    ...
                    <div id="blog-post-body">
                            ...
                            <p>Voxel worlds are typically organized into pages of data called chunks. In Seed Of Andromeda, I have chosen to use a chunk size of 32^3. In contrast, the minecraft chunk size is 16x16x256 [1].
