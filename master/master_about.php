...
$result = mysql_query("SELECT * FROM pages WHERE page = 'about'");
    ...
    <TD width="926" valign="top">
        ...
        <TD height="100%">
            ...
            <TD valign="top" style="border-right: 1px solid black;">
				...
				<TR>
                <TD onClick="window.location.href='/master/master_about.php'" style="font-weight: bold; cursor: pointer; cursor: hand; border-bottom: 1px solid #666666; padding-left: 5px;" height="30" width="100%"><font style="font-size: 12px; font-family: arial;">About</font></TD>
                </TR>
                </table>
