<div class="row clearfix the-team">
    <div class="header"><h1 class="name">Benjamin Arnold</h1><h3 class="title">&nbsp;- Lead Developer</h3></div>
    <div class="col tri-col-2">
        <div class="text">
            Ben is the founding father of the team, having started creating Seed of Andromeda's 
            engine by himself way back in 2012, since then, he oversees the continually growing 
            team's work and spends every ounce of energy on Seed of Andromeda's development. His 
            vision of the future of Seed of Andromeda is what drives and guides the game's development.
            </div>
    </div>
...
<div class="row clearfix the-team">
    ...
    <div class="col tri-col-2">
        <div class="text">
            ...
            having previously worked on some of his own game projects he now works on the design 
            of Seed of Andromeda. Sebastian is multi-talented and spends time on voxel models, 
            tree generation, and general design. He also spends a good amount of time eating pizza 
...
<div class="row clearfix the-team">
    ...
    <div class="col tri-col-2">
        <div class="text">
            ...
            texture mods for Seed of Andromeda and was noticed for his skill and style! He is 
            currently Studying Technical Chemistry in Austria, but enjoys making photorealistic 
            textures in his spare time. No doubt his scientific background will aid Seed of 
...
<div class="row clearfix the-team">
    ...
    <div class="col tri-col-2">
        <div class="text">
            ...
            in Austria, and has studied graphic design. His incredible voxel modeling skills 
            grabbed the attention of the Seed of Andromeda team thanks to his contributions on 
            the forum! As Seed of Andromeda develops further, Andreas will be designing the 3D 
            models and textures. He will also be helping design the voxel damage and animation 
            systems!
            </div>
    </div>
</div>
...
<div class="row clearfix the-team">
    ...
    <div class="col tri-col-2">
        <div class="text">
            ...
            groups and is also the youngest of the team! He is known for his ability for eloquence and for 
            understanding the wants and needs of the community with ease. He rules with a feathery fist of 
