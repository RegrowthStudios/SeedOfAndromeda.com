...
$result = mysql_query("SELECT * FROM pages WHERE page = 'videos'");
    ...
    <TD width="926" valign="top">
        ...
        <TD height="100%">
            ...
            <TD valign="top" style="border-right: 1px solid black;">
				...
				<TR>
                <TD onClick="window.location.href='/master/master_videos.php'" style="font-weight: bold; cursor: pointer; cursor: hand; border-bottom: 1px solid #666666; padding-left: 5px;" height="30" width="100%"><font style="font-size: 12px; font-family: arial;">Videos</font></TD>
                </TR>
				<TR>
            ...
            <TD width="804" height="100%" valign="top">
				...
				<input type="hidden" value="videos" name="page">
				<BR>    
