...
class EWRcarta_ViewPublic_PageCreate extends XenForo_ViewPublic_Base
{
	public function renderHtml()
	{
		...
		$disable = $this->_params['input']['page_type'] == 'html' ? true : false;
		$disable = XenForo_Application::get('options')->EWRcarta_wysiwyg ? $disable : true;

		$this->_params['editorTemplate'] = XenForo_ViewPublic_Helper_Editor::getEditorTemplate(
			$this, 'page_content', $this->_params['input']['page_content'], array('disable' => $disable)
		);
	}
}