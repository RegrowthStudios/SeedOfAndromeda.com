 ...
 */
class XenResource_Route_PrefixAdmin_Categories extends XenForo_Route_PrefixAdmin_Nodes
{
	/**
	...
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		...
		return $router->getRouteMatch('XenResource_ControllerAdmin_Category', $action, 'resourceCategories');
	}
